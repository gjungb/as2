...
class com.adgamewonderland.agw.racing.track.MiniTrackUI extends MovieClip {
	...
	private var SCALE:Number = 3; // massstab in %
	
	private var XSHIFT:Array = new Array(-10, -14, -23, -20, -26, -22, -21, -20, -21, -23, 0);
	
	private var YSHIFT:Array = new Array(2, -15, -12, -7, -1, 2, -8, -21, 9, -7, 0);
	...
	{
		// attachen
		var minivehicle:MovieClip = attachMovie("minivehicle", "minivehicle" + vobj.id + "_mc", getNextHighestDepth(), {_myFrame : vobj.type + 1});
		// speichern
