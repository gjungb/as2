...
class com.adgamewonderland.agw.racing.vehicle.VehicleController {
	...
	public function isVehicleInDirection():Boolean
	{
		// aktuelles streckenteil
		var trackpiece:TrackPiece = getTrackpiece(VehicleController.TRACKPIECE_CURRENT);
		// verbindungsvektor zum naechsten streckenteil
		var conn:Vector = trackpiece.connection;
		// aktueller geschwindigkeitsvektor
		var velo:Vector = myVehicle.velocity;
		// winkel zwischen den vektoren zeigt fahrtrichtung
		var angle:Number = Math.abs(velo.getAngle() - conn.getAngle()) / Math.PI * 180;
		// richtige richtung, wenn kleiner 90 oder groesser 270
