 ...
 * @author gerd
 */
class com.adgamewonderland.eplus.basecasting.ui.CharityaniUI extends LayerUI implements ICityControllerListener {

	function CharityaniUI() {
	}
...
//			CityController.getInstance().changeState(CityController.STATE_LATEST);
	...
	{
		// einblenden, wenn charity
		if (aNewstate == CityController.STATE_CHARITY)
			showLayer();
	}
