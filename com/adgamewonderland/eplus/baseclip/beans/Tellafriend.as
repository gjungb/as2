 ...
 */
class com.adgamewonderland.eplus.baseclip.beans.Tellafriend implements ISendable
{
	/**
	...
	public function getErrors():Array
	{
		...
		params.push(Formprocessor.TYPE_EMPTY, "senderemail", getSenderemail());
		params.push(Formprocessor.TYPE_EMPTY, "receivername", getReceivername());
		params.push(Formprocessor.TYPE_EMPTY, "receiveremail", getReceiveremail());
		// validieren
