...
class com.adgamewonderland.trias.vkftool.Dataconnector {
	...
	private var myFile:Object = {suppliers : "data\\ea_bat_suppliers.csv", userdata : "daten_2005.xml", pccd : "data\\ea_bat_ranking_pccd.csv", ps2 : "data\\ea_bat_ranking_ps2.csv", xbox : "data\\ea_bat_ranking_xbox.csv", gamecube : "data\\ea_bat_ranking_gamecube.csv", gba : "data\\ea_bat_ranking_gba.csv"};
	...
	public function onSuppliersLoaded(res:Array ):Void
	{
		...
		// catalog schliessen
//		myCatalogConnector.closeCatalog(); // verhindert seit 2005 das laden der supplier
	}
