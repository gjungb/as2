...
class com.adgamewonderland.trias.vkftool.reports.Report extends MovieClip {
	...
	private var headline3_txt:TextField, headline4_txt:TextField;
	
	private var reportnavi_mc:MovieClip;
	...
	private  function printReport():Void
	{
		...
		if (started) {
			...
			// report 1 hat zwei headlines
			if (reportnum == 1) {
				headline3_txt._x -= xchart;
				headline4_txt._x -= xchart;
			}
			chart_mc._x -= xchart;
			table_mc._x -= xchart;
