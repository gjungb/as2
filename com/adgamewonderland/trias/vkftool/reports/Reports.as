...
class com.adgamewonderland.trias.vkftool.reports.Reports extends MovieClip {
	...
	private var mySelectedSupplierId:Number;
	...
	public function Reports()
	{
		...
		report = null;
		// ausgwaehlter supplier zum anzeigen von report 4
	...
	public function set selectedsupplierid(num:Number ):Void
	{
		// ausgwaehlter supplier zum anzeigen von report 4
		mySelectedSupplierId = num;
	}
	
	public function get selectedsupplierid():Number
	{
		// ausgwaehlter supplier zum anzeigen von report 4
		return mySelectedSupplierId;
	}
